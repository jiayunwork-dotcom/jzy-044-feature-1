...
ERR_TARGET_UNREACHABLE = "TARGET_UNREACHABLE"      # 分离目标越过理论极限 / 塔高不足
ERR_INVALID_TARGET = "INVALID_TARGET"              # 目标本身给法非法（越界、互相矛盾）
ERR_INVERT_SPEC = "INVERT_SPEC_INVALID"            # 反解已知/未知量指定不全或互相冲突
ERR_SOLVER_NO_CONVERGE = "SOLVER_DID_NOT_CONVERGE"  # 迭代达上限仍未夹住收敛解
